...
class Kegiatan_akademik_model extends CI_Model
{
  public function get_upload_nilai_done($kode_prodi,$thnAkademik,$kd_semester){
    ...
    $this->db->where(" NOT EXISTS (SELECT kd_dosen FROM kegiatan_akademik as ka WHERE thnAkademik='$thnAkademik' AND kd_semester='$kd_semester' AND ka.kd_dosen=d.kd_dosen)");
