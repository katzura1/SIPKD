            ...
            <form action="<?=$action?>" method="post">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="hak" style="width:60%;">
                  ...
                  <option value="9" <?=$hak=='8'?'selected':''?>>KAPRODI MJ</option>
                  <option value="10" <?=$hak=='9'?'selected':''?>>PK-1 STMIK</option>
                  <option value="11" <?=$hak=='10'?'selected':''?>>PK-1 STIE</option>
                </select>
              </div>
              <div class="form-group">
                <label>Password</label>
                <input type="password" name="pass_dosen" value="<?=$pass_dosen?>" style="width:60%;" class="form-control" autocomplete="current-password">
                <?=form_error('pass_dosen')?>
              </div>
              <div class="form-group">
