...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Ketepatan Upload Nilai</li>
    </ol>
</section>
        ...
        <div class="row">
          <div class="col-md-12">
            <table class="table table-striped" id="table1">
              ...
              <tbody>
              <!--done-->
              <?php $i=1; foreach ($data_done as $data): $i++;?>
                <tr>
                  <td></td>
                  <td><?=$data->kd_dosen?></td>
                  <td><?=$data->gelar_depan.' '.$data->nm_dosen.', '.$data->gelar_belakang?></td>
                  <td>
                    <form id="<?="'form$i'"?>" action="<?=site_url('kegiatan_akademik/aksi_isi_nilai')?>" method="post">
              ...
              <?php endforeach; ?>
              <!--not done-->
              <?php foreach ($data_not_done as $data): $i++;?>
                <tr>
                  <td></td>
                  <td><?=$data->kd_dosen?></td>
                  <td><?=$data->gelar_depan.' '.$data->nm_dosen.', '.$data->gelar_belakang?></td>
