            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?=site_url('dashboard1')?>"><i class="fa fa-circle-o"></i>Ketepatan Upload Materi</a></li>
                    <li><a href="<?=site_url('dashboard2') ?>"><i class="fa fa-circle-o"></i>Ketepatan Upload Soal</a></li>
