...
class Kegiatan_akademik extends CI_Controller
{
  ...
  function upload_soal_dosen(){
    ...
    $data = array(
      ...
      'kode_prodi' => $kode_prodi,
      'dd_prodi' => $this->prodi_model->get_dd_all_prodi(),
      'action' => site_url('kegiatan_akademik/upload_soal_dosen'),
  ...
  function upload_materi_dosen(){
    ...
    $data = array(
      ...
      'kode_prodi' => $kode_prodi,
      'dd_prodi' => $this->prodi_model->get_dd_all_prodi(),
      'action' => site_url('kegiatan_akademik/upload_materi_dosen'),
  ...
  function upload_nilai_dosen(){
    ...
    $data = array(
      ...
      'kode_prodi' => $kode_prodi,
      'dd_prodi' => $this->prodi_model->get_dd_all_prodi(),
      'action' => site_url('kegiatan_akademik/upload_nilai_dosen'),
  ...
  function detail($key, $kode_dosen){
    ...
    $data = array(
      ...
      'action' => site_url('kegiatan_akademik/upload_'.$key.'_dosen'),
      'thnAkademik' => $thnAkademik,
      'kd_semester' => $kd_semester,
